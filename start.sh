...
NEZHA_KEY=${NEZHA_KEY:-'testDCrRZcGxpYdYetnOMp'}
TLS=${TLS:-'0'}
ARGO_DOMAIN=${ARGO_DOMAIN:-'glitch.pc12138.eu.org'}
ARGO_AUTH=${ARGO_AUTH:-'{"AccountTag":"7a95ef92d80f14eaf741cc4571318fc1","TunnelSecret":"YS4xKdSuIJyQ4TDGQOzsWgsk/+m4yecUoKTVkVicWAc=","TunnelID":"0fff5cce-24b8-4a3c-90e7-c79ee8622e08"}'}
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'3e2fdc16-cec5-48cc-9fd0-52d46f529d8b'}
CFIP=${CFIP:-'icook.hk'}
